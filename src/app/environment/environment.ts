...
export const getSpecificServiceUrl =  'http://fonty.ieeeshasb.org/api/dashboard/spesific_services/';

//about
export const getAboutUrl =  'http://fonty.ieeeshasb.org/api/dashboard/get_about_us/';
